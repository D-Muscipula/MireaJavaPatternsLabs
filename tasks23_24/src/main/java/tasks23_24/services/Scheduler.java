...
@Service
@Log4j2
@ManagedResource(objectName = "tasks23_24.services:type=Scheduler")
public class Scheduler {
    ...
    public void clearAndCreateFiles() throws IOException {
        ...
        File entities = new File("tasks23_24/src/main/resources/entities");
        ...
        for (Address address : addresses) {
            OutputStreamWriter writer = new OutputStreamWriter(
                    new FileOutputStream("tasks23_24/src/main/resources/entities/address" + address.getId() + ".txt"),
        ...
        for (Building building : buildings) {
            OutputStreamWriter writer = new OutputStreamWriter(
                    new FileOutputStream("tasks23_24/src/main/resources/entities/building" + building.getId() + ".txt"),
                    StandardCharsets.UTF_8);
